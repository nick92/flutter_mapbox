...
class FlutterMapboxView(context: Context, activity: Activity, lifecycle: Lifecycle, binding: MapActivityBinding, binaryMessenger: BinaryMessenger, vId: Int, args: Any?, accessToken: String)
